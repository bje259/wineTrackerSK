...
import WineCellerFlat from './WineCellarFlat';
import {myWineCellarFlat, storeExample, useNewDataType } from './store';
import type { Cellar, CellarFlat, WineFlat, InvItem } from './types';
...
export const wineFlat: WineFlat = {
	Producer: '',
	'Wine Name': '',
	'Vineyard Location': '',
	Variety: '',
